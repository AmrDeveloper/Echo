...
static void endScope() {
    ...
    while (current->localCount > 0 &&
        ...
        //Free the stack slots for the locals,
...
ParseRule rules[] = {
        ...
        {NULL,  andOperator, PREC_AND},       // TOKEN_AND
        ...
        {NULL,  orOperator,  PREC_OR},       // TOKEN_OR
...
/**
 * Compile This Code into bytecode
 */
static void parsePrecedence(Precedence precedence) {
    advance();
...
static void classDeclaration() {
    ...
    //linked list to keep a pointer to the ClassCompiler for the enclosing class
    ...
    //Check if class inherit other class if the next token is <
    //inherit format is SubClass < SuperClass
    if (match(TOKEN_LESS)) {
    ...
    //we no longer need the class and pop it off the stack
    emitByte(OP_POP);
